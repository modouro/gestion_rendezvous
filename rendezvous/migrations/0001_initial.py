# Generated by Django 5.1.1 on 2024-12-26 15:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveIntegerField(default=0, verbose_name='Âge')),
                ('adresse', models.CharField(max_length=255, verbose_name='Adresse')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('titre', models.CharField(max_length=100, verbose_name='Titre du rendez-vous')),
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rendezvous', to='rendezvous.patient', verbose_name='Patient')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rendezvous', to=settings.AUTH_USER_MODEL, verbose_name='Utilisateur')),
            ],
            options={
                'unique_together': {('patient', 'date', 'heure')},
            },
        ),
    ]
